...
* To create the simple model we will drop variables related to search, frisk, and physical force following the `X_train_subset` conservative approach, as it is unclear if these occurred before or after arrests. 
