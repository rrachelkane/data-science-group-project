...
```
*Note - Lucas* Surprised at low sensitivity of Random Forest - could this have something to do with the max number of features we include? I know this makes life very difficult and takes up a lot of computational time but we could keep it low and then run it up to 80 when we are fully finished with the code?

## Tuning ntree 

## Variable Importance
*Note - Lucas* Search Basis incidental to arrest happens after arrest => should be dropped
...
```
*Note - Lucas* Could use this approach to optimise over alpha
