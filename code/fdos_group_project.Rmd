...
for (alpha in alpha_values) {
  #Train Elastic Net model for the given alpha
  en_opt_subset <- cv.glmnet(X_train_en_subset, y_train_en, alpha = alpha, family = "binomial", type.measure = "class")
  ...
  # Compute AUC
  en_opt_auc_value_subset <- auc(response = y_val_en, predictor = en_opt_y_prob_subset)
...
en_opt_best_auc_subset <- auc(response = y_test_en, predictor = en_opt_y_test_subset)
